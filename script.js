...
const UPPERCASE_CHAR_CODES =  arrrayFromLowToHigh(65, 90)
const NUMBER_CHAR_CODES =  arrrayFromLowToHigh(48, 57)
const LOWERCASE_CHAR_CODES =  arrrayFromLowToHigh(97, 122)
const SYMBOLS_CHAR_CODES =  arrrayFromLowToHigh(33, 47).concat(
